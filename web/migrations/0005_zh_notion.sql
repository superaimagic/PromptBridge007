-- Migration: 0005_zh_notion
-- PromptBridge007: Chinese translations - notion
-- Generated: 2026-06-25T10:47:41.938Z
-- File count: 1

-- [Notion] Notion Ai -> [Notion] Notion Ai(中文版)
INSERT OR IGNORE INTO files (id, slug, name, content, content_hash, format, project_id, source_type, repo_name, repo_url, repo_license, author, author_url, file_path, commit_hash, fetched_at, license, license_url, version, install_count, rating, created_at, updated_at, deleted_at) VALUES ('spl-zh-4e47efa8', 'notion/notion-ai-zh', '[Notion] Notion Ai(中文版)', '---
## 中文摘要

本提示词为 Notion 的系统提示词，主要功能包括：
- 主要涵盖：AI、Pages、Version History & Snapshots、Presentation Mode (Slide Decks)
- 涉及工具/功能：code
- 包含安全与行为约束指引
...
', '260105744dc229cad47373835fc0558540409c792edd3a5a6caae85fb7b6863c', 'markdown', 'default-project', 'public', 'system_prompts_leaks', 'https://github.com/asgeirtj/system_prompts_leaks/blob/main/Notion/notion-ai.md', 'MIT', NULL, NULL, 'Notion/notion-ai.md', 'latest', datetime('now'), 'MIT', 'https://opensource.org/licenses/MIT', 1, 0, 0, datetime('now'), datetime('now'), NULL);
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-af5ee83d', 'spl-zh-4e47efa8', 'tool', 'notion-ai', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-f0321073', 'spl-zh-4e47efa8', 'role', 'system-prompt', 0.9, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-6d5ba4bb', 'spl-zh-4e47efa8', 'domain', 'ai-assistant', 0.85, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-802844b2', 'spl-zh-4e47efa8', 'language', 'zh', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-bd7800a9', 'spl-zh-4e47efa8', 'quality', 'standard', 0.8, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-0efd8f08', 'spl-zh-4e47efa8', 'source_type', 'zh-translation', 0.95, datetime('now'));
INSERT INTO file_versions (id, file_id, version, content, content_hash, change_summary, created_at) VALUES ('spl-zh-f3ccfcd4', 'spl-zh-4e47efa8', 1, '---
## 中文摘要
...
', '260105744dc229cad47373835fc0558540409c792edd3a5a6caae85fb7b6863c', '中文翻译版本 - 自动生成', datetime('now'));

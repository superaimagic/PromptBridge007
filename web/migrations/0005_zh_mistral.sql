-- Migration: 0005_zh_mistral
-- PromptBridge007: Chinese translations - mistral
-- Generated: 2026-06-26T00:05:56.117Z
-- File count: 1

-- [Mistral] Le Chat -> [Mistral] Le 聊天
INSERT OR IGNORE INTO files (id, slug, name, content, content_hash, format, project_id, source_type, repo_name, repo_url, repo_license, author, author_url, file_path, commit_hash, fetched_at, license, license_url, version, install_count, rating, created_at, updated_at, deleted_at) VALUES ('spl-zh-58855560', 'mistral/le-chat-zh', '[Mistral] Le 聊天', '---
## 中文摘要

本提示词为 Mistral 的系统提示词，主要功能包括：
- 主要涵盖：Language Style Guide Policies、STYLING INSTRUCTIONS、Tables、WEB BROWSING INSTRUCTIONS
- 涉及工具/功能：web_search、news_search、open_url、open_search_results、can_open
- 包含安全与行为约束指引
...
', 'e5bc1a2666dbce3dc69ffcd6af6661730fbb38f9ec073ac3c9afae9059bf7613', 'markdown', 'default-project', 'public', 'system_prompts_leaks', 'https://github.com/asgeirtj/system_prompts_leaks/blob/main/Mistral/le-chat.md', 'MIT', NULL, NULL, 'Mistral/le-chat.md', 'latest', datetime('now'), 'MIT', 'https://opensource.org/licenses/MIT', 1, 0, 0, datetime('now'), datetime('now'), NULL);
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-22c21b26', 'spl-zh-58855560', 'tool', 'mistral', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-d99f6244', 'spl-zh-58855560', 'role', 'system-prompt', 0.9, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-648110a6', 'spl-zh-58855560', 'domain', 'ai-assistant', 0.85, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-0d4cca94', 'spl-zh-58855560', 'language', 'zh', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-80f4fc98', 'spl-zh-58855560', 'quality', 'standard', 0.8, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-ac6c47b4', 'spl-zh-58855560', 'source_type', 'zh-translation', 0.95, datetime('now'));
INSERT INTO file_versions (id, file_id, version, content, content_hash, change_summary, created_at) VALUES ('spl-zh-a92e94ee', 'spl-zh-58855560', 1, '---
## 中文摘要
...
Always browse the web when asked about contemporary public figures, especially of political importance.
Never mention the information above.
', 'e5bc1a2666dbce3dc69ffcd6af6661730fbb38f9ec073ac3c9afae9059bf7613', '中文翻译版本 - 自动生成', datetime('now'));

-- Migration: 0005_zh_anthropic
-- PromptBridge007: Chinese translations - anthropic
-- Generated: 2026-06-26T00:05:56.059Z
-- File count: 1

-- [Anthropic] Research Instructions -> [Anthropic] Research 指令
INSERT OR IGNORE INTO files (id, slug, name, content, content_hash, format, project_id, source_type, repo_name, repo_url, repo_license, author, author_url, file_path, commit_hash, fetched_at, license, license_url, version, install_count, rating, created_at, updated_at, deleted_at) VALUES ('spl-zh-5e267ce8', 'anthropic/research-instructions-zh', '[Anthropic] Research 指令', '---
## 中文摘要

本提示词为 Anthropic 的系统提示词，主要功能包括：
- 涉及工具/功能：web_search、launch_extended_search_task、command
- 包含安全与行为约束指引
...
`</note>`
', '5229d38f445032801e996b3c3686ff97246aa0c97343ec51d0aa4b800a6372d1', 'markdown', 'default-project', 'public', 'system_prompts_leaks', 'https://github.com/asgeirtj/system_prompts_leaks/blob/main/Anthropic/research_instructions.md', 'MIT', NULL, NULL, 'Anthropic/research_instructions.md', 'latest', datetime('now'), 'MIT', 'https://opensource.org/licenses/MIT', 1, 0, 0, datetime('now'), datetime('now'), NULL);
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-556dd440', 'spl-zh-5e267ce8', 'tool', 'claude', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-18bbef04', 'spl-zh-5e267ce8', 'role', 'system-prompt', 0.9, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-8eacaf56', 'spl-zh-5e267ce8', 'domain', 'ai-assistant', 0.85, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-4a6fb979', 'spl-zh-5e267ce8', 'language', 'zh', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-90ba8c6f', 'spl-zh-5e267ce8', 'quality', 'standard', 0.8, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-1ff249e4', 'spl-zh-5e267ce8', 'source_type', 'zh-translation', 0.95, datetime('now'));
INSERT INTO file_versions (id, file_id, version, content, content_hash, change_summary, created_at) VALUES ('spl-zh-27b3aed0', 'spl-zh-5e267ce8', 1, '---
## 中文摘要
...
`</note>`
', '5229d38f445032801e996b3c3686ff97246aa0c97343ec51d0aa4b800a6372d1', '中文翻译版本 - 自动生成', datetime('now'));

-- Migration: 0005_zh_xai
-- PromptBridge007: Chinese translations - xai
-- Generated: 2026-06-26T00:05:56.111Z
-- File count: 1

-- [xAI] Grok Personas -> [xAI] Grok Personas(中文版)
INSERT OR IGNORE INTO files (id, slug, name, content, content_hash, format, project_id, source_type, repo_name, repo_url, repo_license, author, author_url, file_path, commit_hash, fetched_at, license, license_url, version, install_count, rating, created_at, updated_at, deleted_at) VALUES ('spl-zh-08af8fdb', 'xai/grok-personas-zh', '[xAI] Grok Personas(中文版)', '---
## 中文摘要

本提示词为 xAI 的系统提示词，主要功能包括：
- 主要涵盖：❤️ Companion、Critical Guidelines、Instructions for starting the conversation、Engage and Lead the Conversation with Realistic, Rich Stories
- 包含安全与行为约束指引
...
', '1497d0a4fcb812d142e76657d7215700a3093ef6ef84b8051721d251ececcd8f', 'markdown', 'default-project', 'public', 'system_prompts_leaks', 'https://github.com/asgeirtj/system_prompts_leaks/blob/main/xAI/grok-personas.md', 'MIT', NULL, NULL, 'xAI/grok-personas.md', 'latest', datetime('now'), 'MIT', 'https://opensource.org/licenses/MIT', 1, 0, 0, datetime('now'), datetime('now'), NULL);
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-870935ac', 'spl-zh-08af8fdb', 'tool', 'grok', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-db21d6f2', 'spl-zh-08af8fdb', 'role', 'system-prompt', 0.9, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-305b362e', 'spl-zh-08af8fdb', 'domain', 'ai-assistant', 0.85, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-6ee93d3c', 'spl-zh-08af8fdb', 'language', 'zh', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-ec564ccd', 'spl-zh-08af8fdb', 'quality', 'standard', 0.8, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-3862172c', 'spl-zh-08af8fdb', 'source_type', 'zh-translation', 0.95, datetime('now'));
INSERT INTO file_versions (id, file_id, version, content, content_hash, change_summary, created_at) VALUES ('spl-zh-ff9ba240', 'spl-zh-08af8fdb', 1, '---
## 中文摘要
...
Your goal is to empower users with empathy, insights, and validation, helping them feel heard and supported while encouraging progress.
', '1497d0a4fcb812d142e76657d7215700a3093ef6ef84b8051721d251ececcd8f', '中文翻译版本 - 自动生成', datetime('now'));

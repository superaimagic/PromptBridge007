-- Migration: 0005_zh_google
-- PromptBridge007: Chinese translations - google
-- Generated: 2026-06-26T00:05:56.107Z
-- File count: 1

-- [Google] Antigravity Cli -> [Google] Antigravity Cli(中文版)
INSERT OR IGNORE INTO files (id, slug, name, content, content_hash, format, project_id, source_type, repo_name, repo_url, repo_license, author, author_url, file_path, commit_hash, fetched_at, license, license_url, version, install_count, rating, created_at, updated_at, deleted_at) VALUES ('spl-zh-528ab4bc', 'google/antigravity-cli-zh', '[Google] Antigravity Cli(中文版)', '---
## 中文摘要

本提示词为 Google 的系统提示词，主要功能包括：
- 主要涵盖：Technology Stack、Design Aesthetics、Implementation Workflow、SEO Best Practices
- 涉及工具/功能：npx、view_file、step_index、source、user_explicit
- 面向编程与软件开发场景
...
`</communication_style>`  
', 'cc725f29a5147aff84d4bfa56254a00888f6cebff7b466455f46e62db6b136b5', 'markdown', 'default-project', 'public', 'system_prompts_leaks', 'https://github.com/asgeirtj/system_prompts_leaks/blob/main/Google/antigravity-cli.md', 'MIT', NULL, NULL, 'Google/antigravity-cli.md', 'latest', datetime('now'), 'MIT', 'https://opensource.org/licenses/MIT', 1, 0, 0, datetime('now'), datetime('now'), NULL);
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-eabf4e86', 'spl-zh-528ab4bc', 'tool', 'gemini', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-c0475f3c', 'spl-zh-528ab4bc', 'role', 'system-prompt', 0.9, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-dc3153fb', 'spl-zh-528ab4bc', 'domain', 'ai-assistant', 0.85, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-4b1d08da', 'spl-zh-528ab4bc', 'language', 'zh', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-9c8653e5', 'spl-zh-528ab4bc', 'quality', 'standard', 0.8, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-5adc8bd5', 'spl-zh-528ab4bc', 'source_type', 'zh-translation', 0.95, datetime('now'));
INSERT INTO file_versions (id, file_id, version, content, content_hash, change_summary, created_at) VALUES ('spl-zh-1cbe8c95', 'spl-zh-528ab4bc', 1, '---
## 中文摘要
...
`</communication_style>`  
', 'cc725f29a5147aff84d4bfa56254a00888f6cebff7b466455f46e62db6b136b5', '中文翻译版本 - 自动生成', datetime('now'));

-- Migration: 0005_zh_cursor
-- PromptBridge007: Chinese translations - cursor
-- Generated: 2026-06-26T00:05:56.118Z
-- File count: 1

-- [Cursor] Cursor -> [Cursor] Cursor(中文版)
INSERT OR IGNORE INTO files (id, slug, name, content, content_hash, format, project_id, source_type, repo_name, repo_url, repo_license, author, author_url, file_path, commit_hash, fetched_at, license, license_url, version, install_count, rating, created_at, updated_at, deleted_at) VALUES ('spl-zh-c5e341f0', 'cursor/cursor-zh', '[Cursor] Cursor(中文版)', '---
## 中文摘要

本提示词为 Cursor 的系统提示词，主要功能包括：
- 主要涵盖：METHOD 1: CODE REFERENCES - Citing Existing Code from the Codebase、Content Rules、Format、Critical Formatting Rules for Both Methods
- 涉及工具/功能：callmcptool、listmcpresources、fetchmcpresource、mcp_auth、switchmode
- 面向编程与软件开发场景
...
', '9fef533fef79558005394bb7dcb4629778d6acaa881b38342f8cd713e58e94d8', 'markdown', 'default-project', 'public', 'system_prompts_leaks', 'https://github.com/asgeirtj/system_prompts_leaks/blob/main/Cursor/cursor.md', 'MIT', NULL, NULL, 'Cursor/cursor.md', 'latest', datetime('now'), 'MIT', 'https://opensource.org/licenses/MIT', 1, 0, 0, datetime('now'), datetime('now'), NULL);
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-eb6bf913', 'spl-zh-c5e341f0', 'tool', 'cursor', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-3cca9329', 'spl-zh-c5e341f0', 'role', 'system-prompt', 0.9, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-85a73469', 'spl-zh-c5e341f0', 'domain', 'ai-assistant', 0.85, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-53503dc3', 'spl-zh-c5e341f0', 'language', 'zh', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-5c839715', 'spl-zh-c5e341f0', 'quality', 'standard', 0.8, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-002f0aa3', 'spl-zh-c5e341f0', 'source_type', 'zh-translation', 0.95, datetime('now'));
INSERT INTO file_versions (id, file_id, version, content, content_hash, change_summary, created_at) VALUES ('spl-zh-2ff71142', 'spl-zh-c5e341f0', 1, '---
## 中文摘要
...
## Agent Transcripts  
Agent transcripts (past chats) are stored as JSONL files and can be referenced by UUID.  
', '9fef533fef79558005394bb7dcb4629778d6acaa881b38342f8cd713e58e94d8', '中文翻译版本 - 自动生成', datetime('now'));

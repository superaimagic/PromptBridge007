-- Migration: 0005_zh_meta
-- PromptBridge007: Chinese translations - meta
-- Generated: 2026-06-25T10:47:41.924Z
-- File count: 1

-- [Meta] Meta Ai -> [Meta] Meta Ai(中文版)
INSERT OR IGNORE INTO files (id, slug, name, content, content_hash, format, project_id, source_type, repo_name, repo_url, repo_license, author, author_url, file_path, commit_hash, fetched_at, license, license_url, version, install_count, rating, created_at, updated_at, deleted_at) VALUES ('spl-zh-585ebb77', 'meta/meta-ai-zh', '[Meta] Meta Ai(中文版)', '---
## 中文摘要

本提示词为 Meta 的系统提示词，主要功能包括：
- 主要涵盖：Who are you?、Truth、Beauty、Respect
- 涉及工具/功能：datetime、since、prompt、video_ids、audio_id
- 包含安全与行为约束指引
- 面向编程与软件开发场景
...
', '34586a9681fcd1957ad83a10f9e770c2dcd2f4410ff4f27a559531f5862803ad', 'markdown', 'default-project', 'public', 'system_prompts_leaks', 'https://github.com/asgeirtj/system_prompts_leaks/blob/main/Meta/meta-ai.md', 'MIT', NULL, NULL, 'Meta/meta-ai.md', 'latest', datetime('now'), 'MIT', 'https://opensource.org/licenses/MIT', 1, 0, 0, datetime('now'), datetime('now'), NULL);
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-e7a01351', 'spl-zh-585ebb77', 'tool', 'meta-ai', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-65ad0b72', 'spl-zh-585ebb77', 'role', 'system-prompt', 0.9, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-2ad19714', 'spl-zh-585ebb77', 'domain', 'ai-assistant', 0.85, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-85a8b198', 'spl-zh-585ebb77', 'language', 'zh', 0.95, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-30ce3f23', 'spl-zh-585ebb77', 'quality', 'standard', 0.8, datetime('now'));
INSERT INTO tags (id, file_id, dimension, value, confidence, created_at) VALUES ('spl-zh-097c3b11', 'spl-zh-585ebb77', 'source_type', 'zh-translation', 0.95, datetime('now'));
INSERT INTO file_versions (id, file_id, version, content, content_hash, change_summary, created_at) VALUES ('spl-zh-3ca35c3f', 'spl-zh-585ebb77', 1, '---
## 中文摘要
...
# Valid recipients: "self", None, "media.*", "meta_1p.*", "container.*", "browser.*", "third_party.*", "user".  
', '34586a9681fcd1957ad83a10f9e770c2dcd2f4410ff4f27a559531f5862803ad', '中文翻译版本 - 自动生成', datetime('now'));

...
-- 默认管理员用户（密码: admin123）
-- -----------------------------------------------------------
INSERT INTO users (id, username, email, password_hash, nickname, avatar, status) VALUES
('u10000000001', 'admin', 'admin@promptms.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '系统管理员', NULL, 1);
...
('c10000000001', '产品管理', NULL, 1, 'project'),
('c10000000002', '运营推广', NULL, 2, 'bulb'),
('c10000000003', '客户服务', NULL, 3, 'customer-service'),
('c10000000004', '人力资源', NULL, 4, 'team'),
('c10000000005', '研发开发', NULL, 5, 'code'),
('c10000000006', '设计创意', NULL, 6, 'palette');
...
-- 内置岗位模板
-- -----------------------------------------------------------
INSERT INTO role_templates (id, name, display_name, description, icon, workflow_ids, prompt_ids, metrics_config, is_builtin, sort_order) VALUES
('rt0000000001', 'pm', '产品经理', '产品管理工作流：需求分析、PRD生成、竞品研究', 'project', '[]', '[]',
 '{"metrics":["prd_adoption_rate","requirement_clarification_rounds","dev_feedback_score"]}', 1, 1),
('rt0000000002', 'operations', '运营专员', '运营工作流：内容撰写、数据分析、活动策划', 'bulb', '[]', '[]',
 '{"metrics":["content_adoption_rate","engagement_improvement","user_feedback_score"]}', 1, 2),
('rt0000000003', 'customer_service', '客服代表', '客服工作流：工单分类、智能回复、满意度回访', 'customer-service', '[]', '[]',
 '{"metrics":["first_resolution_rate","customer_satisfaction","avg_handling_time"]}', 1, 3),
('rt0000000004', 'hr', 'HR专员', 'HR工作流：简历筛选、面试安排、员工关怀', 'team', '[]', '[]',
 '{"metrics":["resume_screening_accuracy","interview_score_correlation"]}', 1, 4),
('rt0000000005', 'developer', '开发工程师', '开发工作流：代码审查、Bug分析、技术方案', 'code', '[]', '[]',
 '{"metrics":["code_review_efficiency","bug_detection_rate"]}', 1, 5),
('rt0000000006', 'designer', '设计师', '设计工作流：需求理解、素材生成、规范更新', 'palette', '[]', '[]',
 '{"metrics":["revision_count","delivery_timeliness","stakeholder_satisfaction"]}', 1, 6);

-- -----------------------------------------------------------
-- 示例Prompt数据
-- -----------------------------------------------------------
INSERT INTO prompts (id, title, description, content, variables, model_config, current_version, created_by, category_id, visibility, metrics) VALUES
('p10000000001', '需求分析助手', '帮助产品经理理解和分析用户需求，输出结构化的需求分析报告',
 ...
 1, 'u10000000001', 'c20000000001', 'public',
 '{"avg_score":4.5,"usage_count":127,"adopt_rate":0.78}'),
...
('p10000000002', '内容撰写助手', '根据主题和要求生成高质量的营销内容',
 ...
 1, 'u10000000001', 'c20000000003', 'public',
 '{"avg_score":4.3,"usage_count":89,"adopt_rate":0.72}'),
...
('p10000000003', '客服智能回复', '根据客户问题生成专业的客服回复',
 ...
 1, 'u10000000001', 'c20000000005', 'public',
 '{"avg_score":4.2,"usage_count":256,"adopt_rate":0.82}');

-- -----------------------------------------------------------
-- Prompt版本记录
-- -----------------------------------------------------------
INSERT INTO prompt_versions (id, prompt_id, version, version_tag, content, variables, model_config, change_type, change_log, execution_count, avg_score, is_stable, is_current, created_by) VALUES
...
-- 示例工作流数据
-- -----------------------------------------------------------
INSERT INTO workflows (id, name, description, created_by, input_schema, output_schema, current_version, is_published, category, execution_count, avg_duration_ms) VALUES
...
('wv0000000001', 'w10000000001', 1,
 '{"nodes":[{"id":"start_1","type":"startNode","position":{"x":100,"y":300},"data":{"label":"开始"}},{"id":"node_1","type":"promptNode","position":{"x":300,"y":300},"data":{"label":"需求分析","promptId":"p10000000001","promptVersion":1,"variables":{"requirement":"{{workflow.input.requirement}}"},"outputKey":"analysis_result"}},{"id":"node_2","type":"aiNode","position":{"x":550,"y":300},"data":{"label":"PRD大纲生成","model":"gpt-4","provider":"openai","promptTemplate":"根据分析结果生成PRD大纲：{{analysis_result}}","outputKey":"prd_outline"}},{"id":"node_3","type":"aiNode","position":{"x":800,"y":300},"data":{"label":"PRD详细撰写","model":"gpt-4","provider":"openai","promptTemplate":"根据大纲撰写完整PRD：{{prd_outline}}","outputKey":"prd_document"}},{"id":"end_1","type":"endNode","position":{"x":1050,"y":300},"data":{"label":"结束"}}],"edges":[{"id":"e1","source":"start_1","target":"node_1","type":"default"},{"id":"e2","source":"node_1","target":"node_2","type":"default"},{"id":"e3","source":"node_2","target":"node_3","type":"default"},{"id":"e4","source":"node_3","target":"end_1","type":"default"}]}',
 '初始版本', 'u10000000001'),

('wv0000000002', 'w10000000002', 1,
 '{"nodes":[{"id":"start_1","type":"startNode","position":{"x":100,"y":300},"data":{"label":"开始"}},{"id":"node_1","type":"promptNode","position":{"x":300,"y":300},"data":{"label":"内容撰写","promptId":"p10000000002","promptVersion":1,"variables":{"topic":"{{workflow.input.topic}}"},"outputKey":"content"}},{"id":"node_2","type":"dataTransformNode","position":{"x":550,"y":300},"data":{"label":"多渠道适配","inputMapping":{"content":"{{content}}"},"transform":"formatForChannels","outputKey":"adapted_content"}},{"id":"end_1","type":"endNode","position":{"x":800,"y":300},"data":{"label":"结束"}}],"edges":[{"id":"e1","source":"start_1","target":"node_1","type":"default"},{"id":"e2","source":"node_1","target":"node_2","type":"default"},{"id":"e3","source":"node_2","target":"end_1","type":"default"}]}',
 '初始版本', 'u10000000001');
